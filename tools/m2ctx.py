...
CPP_FLAGS = [
    ...
    "-Iinclude/sys",
    "-Iinclude/compiler",
    "-Iinclude/compiler/gcc",
    "-Iinclude/compiler/ido",
    "-Iinclude/compiler/modern_gcc",
    "-Isrc",
    "-Isrc/ultralib",
    "-Isrc/ultralib/src",
    ...
    "-Isrc/ultralib/src/libc",
    "-Isrc/ultralib/src/mgu",
    "-Isrc/ultralib/src/os",
    "-Isrc/ultralib/src/voice",
    "-D_FINAL_ROM",
    "-DTARGET_N64",
    "-DNDEBUG",
    "-DNON_MATCHING",
